$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: 'id', sortable: false,name: 'roleId', index: 'role_id', width: 80, key: true },
            {label: '角色名称', sortable: false,name: 'roleName', index: "role_name", width: 325},
            {label: '所属部门',sortable: false, name: 'deptName', index: "deptName", width: 525},
            {label: '备注', sortable: false,name: 'remark', index: "remark", width: 425},
