    ...
    methods: {
        ...
        pinjie: function (subjects, test, size, counts, jungles, time) {
            ...
            var html = " <div class=\"test_paper_top\" ><div class=\"paper_title\">" + test.name + " </div> <div class=\"paper_right\">总共<label>"
                ...
                "<input type=\"button\" class=\"btn btn-warning\" id='tijiao' value=\"提交作业\"\n" +
                "/>" +
                "<input type=\"button\" class=\"btn btn-warning\" id='jiancha' value=\"检查作业\"\n" +
                ...
                for (var subject in subjects) {
                    ...
                    if (subject.indexOf("单") != -1) {
                        ...
                        if (length < 20) {
                            for (i = 0; i < length; i++) {
                                if ((i + 1) % 20 != 0) {
                                    html += "<td><input type='button' class='btn' value='" + (i + 1) + "' id='x" + index1 + "'/></td>";
                                } else {
                                    html += "</tr><tr><td><input type='button' class='btn' value='" + (i + 1) + "' id='x" + index1 + "'/></td>";
                                }
                                index1++;
                            }
